...
void addBioluminescenceBank (std::vector<Preset>& out)
{
    ...
    out.push_back (make (kBiolum, "ETERNAL LAMP", "Drone", { "Glassy", "Cinematic", "Deep" }, Dry::No,
        "Set the resonator's decay near the top of its range and a single "
        "note keeps ringing for the better part of eight seconds after you "
    ...
    },
    {
        ...
        { ModSource::Current,     ModDest::ResonatorScatter,  0.35f },
        { ModSource::Current,     ModDest::ShapeA,            0.30f },
        { ModSource::Drift,       ModDest::FineAll,           0.12f, true },
        { ModSource::Drift,       ModDest::ResonatorDamping, -0.30f },
        { ModSource::ModWheel,    ModDest::ResonatorDecay,    0.40f },
        { ModSource::Aftertouch,  ModDest::ReverbMix,         0.35f },
    }));

    // --- DRY AQUATIC #23 ---------------------------------------------------
    out.push_back (make (kBiolum, "PILOT LIGHT", "Drone", { "Calm", "Dark", "Organic" }, Dry::Yes,
        "The quietest thing in the bank. One small flame kept burning: two "
        "voices, a narrow-ish image, a low output ceiling, and a resonator "
        "damped to its fundamental. Meant to sit under other presets rather "
        "than be listened to on its own.",
    {
        RIPPLES_FX_BYPASSED,
        ...
        { pid::driftAmount,   0.40f },
        { pid::driftStereo,   0.85f },
        { pid::rippleRate,    rippleHz (0.4f) },
        { pid::rippleDecay,   0.40f },
        { pid::rippleDepth,   0.15f },
        { pid::rippleSpread,  0.75f },
    ...
    },
    {
        ...
        { ModSource::Drift,       ModDest::FineAll,          0.09f, true },
        ...
        { ModSource::ModWheel,    ModDest::Amplitude,        0.30f },
        { ModSource::Aftertouch,  ModDest::FilterCutoff,     0.30f },
    }));

    // --- DRY AQUATIC #24 ---------------------------------------------------
    out.push_back (make (kBiolum, "COLD VIGIL", "Drone", { "Dark", "Glassy", "Submerged" }, Dry::Yes,
        "Waiting in the dark with one light on. A low Water body with a Glass "
        "octave above it that never quite tunes — Drift keeps pulling it a "
    ...
    {
        { ModSource::Drift,       ModDest::PitchB,           0.04f, true },
        { ModSource::Drift,       ModDest::PanB,             0.55f, true },
        { ModSource::Drift,       ModDest::ResonatorSize,    0.35f, true },
        { ModSource::Tide,        ModDest::FilterCutoff,     0.30f },
        { ModSource::Current,     ModDest::ShapeA,           0.35f },
        { ModSource::Current,     ModDest::ResonatorDamping,-0.30f },
    ...
    out.push_back (make (kBiolum, "STARVEIL", "Drone", { "Bright", "Dreamy", "Surface" }, Dry::No,
        "A drone made entirely of top end. The high-pass sits above middle C "
        "so there is no body at all, only a sheet of glass partials and Air "
    ...
    {
        { ModSource::Tide,        ModDest::LevelA,           0.30f },
        { ModSource::Tide,        ModDest::PanA,             0.45f },
        { ModSource::Current,     ModDest::NoiseTone,        0.35f },
        { ModSource::Current,     ModDest::ShapeA,           0.40f },
        { ModSource::Drift,       ModDest::FineAll,          0.14f, true },
        { ModSource::Drift,       ModDest::PanB,            -0.55f, true },
        { ModSource::Ripple,      ModDest::ResonatorScatter, 0.30f },
        { ModSource::ModWheel,    ModDest::NoiseLevel,       0.40f },
        { ModSource::Aftertouch,  ModDest::ResonatorAmount,  0.30f },
    ...
    out.push_back (make (kBiolum, "IGNITION BLOOM", "FX", { "Bright", "Cinematic", "Chaotic" }, Dry::No,
        "A riser that lights rather than screams. Six seconds of Swell tide "
        "driving cutoff, resonator amount and droplet density together, so "
    ...
    {
        { ModSource::Tide,        ModDest::FilterCutoff,     0.80f },
        { ModSource::Tide,        ModDest::ResonatorAmount,  0.50f },
    ...
    out.push_back (make (kBiolum, "LIGHT BURST", "FX", { "Bright", "Chaotic", "Glassy" }, Dry::No,
        "An impact made of glass. A white noise burst two milliseconds long "
        "is thrown into a fully-scattered plate resonator at maximum "
        ...
        "and there is no oscillator sustain behind it at all.",
    {
        ...
        { pid::fenvAttack,    att (0.001f) },
        { pid::fenvDecay,     dec (0.010f) },
        { pid::fenvSustain,   0.00f },
        { pid::fenvRelease,   rel (0.05f) },
        { pid::fenvVelocity,  0.95f },

        { pid::aenvAttack,    att (0.001f) },
        { pid::aenvDecay,     dec (0.04f) },
        { pid::aenvSustain,   0.00f },
        { pid::aenvRelease,   rel (0.06f) },
        { pid::aenvVelocity,  0.95f },
    ...
    {
        { ModSource::ModEnvelope,   ModDest::NoiseLevel,       0.80f },
        { ModSource::ModEnvelope,   ModDest::FilterCutoff,     0.60f },
        { ModSource::Velocity,      ModDest::ResonatorDecay,   0.45f },
        { ModSource::Velocity,      ModDest::ResonatorSize,    0.35f },
        { ModSource::Velocity,      ModDest::NoiseLevel,       0.40f },
        { ModSource::Ripple,        ModDest::ResonatorScatter, 0.45f },
        { ModSource::RandomPerNote, ModDest::ResonatorSize,    0.50f },
        { ModSource::RandomPerNote, ModDest::PanA,             0.60f },
        { ModSource::KeyTrack,      ModDest::ResonatorSize,   -0.40f },
    }));

    out.push_back (make (kBiolum, "STROBE REEF", "FX", { "Chaotic", "Bright", "Wet" }, Dry::No,
        "The whole reef flashing at once, forty times a second. The Ripple "
        "is the entire effect: amplitude, pan and resonator damping all "
        ...
        "held note becomes a strobing field rather than a tone.",
    {
        ...
        { pid::rippleDepth,   1.00f },
        { pid::rippleCycles,  cycles (32.0f) },
        { pid::rippleSpread,  1.00f },
        { pid::ripplePolarity, on },
        { pid::rippleTrigger, rtg (RippleTrigger::NoteOn) },
    ...
    {
        { ModSource::Ripple,      ModDest::Amplitude,        0.95f },
        { ModSource::Ripple,      ModDest::PanA,             0.70f },
        { ModSource::Ripple,      ModDest::PanB,            -0.70f },
        { ModSource::Ripple,      ModDest::ResonatorDamping, 0.50f },
        { ModSource::Ripple,      ModDest::FilterCutoff,     0.45f },
        { ModSource::Tide,        ModDest::ResonatorScatter, 0.40f },
        { ModSource::Current,     ModDest::DropletDensity,   0.50f },
        { ModSource::Drift,       ModDest::FilterCutoff,     0.35f, true },
        { ModSource::ModWheel,    ModDest::DelayFeedback,    0.40f },
    }));

    out.push_back (make (kBiolum, "DYING GLOW", "FX", { "Dark", "Cinematic", "Submerged" }, Dry::No,
        "A light going out over twelve seconds. Everything is wired to the "
        "amp envelope's fall: cutoff drops, the resonator's damping closes "
        ...
        "not just get quieter, it loses its partials one layer at a time.",
    {
        ...
        { pid::resoDecay,     0.86f },
        { pid::resoDamping,   0.24f },
        { pid::resoScatter,   0.54f },
        { pid::resoMotion,    0.55f },

        { pid::scurEnable,    on },
        { pid::scurAmount,    0.45f },
        { pid::dlyEnable,     on },
        { pid::dlyTime,       dtime (1.30f) },
        { pid::dlyFeedback,   0.58f },
        { pid::dlyMotion,     0.45f },
    ...
    {
        { ModSource::AmpEnvelope, ModDest::FilterCutoff,      0.70f },
        { ModSource::AmpEnvelope, ModDest::ResonatorDamping, -0.65f },
        { ModSource::AmpEnvelope, ModDest::FilterDrive,       0.45f },
        { ModSource::AmpEnvelope, ModDest::LevelA,            0.35f },
        { ModSource::ModEnvelope, ModDest::ResonatorScatter, -0.40f },
        { ModSource::Tide,        ModDest::ResonatorSize,     0.30f },
        { ModSource::Current,     ModDest::PanB,              0.40f },
        { ModSource::Drift,       ModDest::FineAll,           0.10f },
        { ModSource::Velocity,    ModDest::ResonatorDecay,    0.35f },
    }));

    out.push_back (make (kBiolum, "LUMINOUS COLLAPSE", "FX", { "Deep", "Cinematic", "Dark" }, Dry::No,
        "The reverse of a riser. A bright glassy swell rises for four "
        "seconds, then the mod envelope inverts the filter and pushes the "
        "sub up two octaves below, so the whole thing falls out of the top "
    ...
    },
    {
        ...
        { ModSource::ModEnvelope, ModDest::PitchAll,         -0.08f },
        { ModSource::ModEnvelope, ModDest::SubLevel,          0.70f },
        { ModSource::Tide,        ModDest::LevelA,            0.45f },
        { ModSource::Tide,        ModDest::ResonatorAmount,   0.35f },
        { ModSource::Current,     ModDest::ShapeA,            0.40f },
        { ModSource::Drift,       ModDest::PanA,              0.45f, true },
